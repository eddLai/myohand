...
# ANGLEACT span of this unit; keep in sync with hand_safety.c
ANG_CLOSED = 890
ANG_OPEN = 1850
...
def ang_to_target(ang):
    """ANGLEACT mapped onto the 0..2000 target scale (hs_ang_to_target)."""
    t = (int(ang) - ANG_CLOSED) * 2000 // (ANG_OPEN - ANG_CLOSED)
    return clamp(t, 0, 2000)
